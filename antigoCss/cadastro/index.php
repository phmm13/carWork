...
<html>
<head>
  <title>Cadastro / Login - CarWork Beta</title>
  ...
  <div class="form">
      ...
      <div class="tab-content">
         ...
         <div id="login">   
          ...
          <p class="forgot"><a href="recuperar_senha.php">Esqueceu sua senha?</a></p>
          
          <button class="button button-block" name="login" />Logar</button>
