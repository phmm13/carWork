                        ...
                        <div>
                            <div>
                                    ...
                                    <div id="carousel" class="slide carousel carousel-fade">
                                        <div class="carousel-inner">
                                            <div class="item active">
                                                <img src="media/slide/1.jpg" alt="sliderImg" />
                                                <div class="container">
                                ...
                                <div class="content-element5">
                                    <div class="container">
                                        <h3 class="section-title">Busque por Modelos</h3>
                                        <div class="brend-section flex-row row">
                                            ...
                                            <div class="col-md-2 col-sm-4 col-xs-6">
                                                <div class="brend-item">
                                                    <figure><img src="images/brend4.png" alt=""></figure>
                                                    <h6>Chevrolet</h6>
                                                    <ul>
                                                        <li><a href="#">Aveo</a></li>
                                                        <li><a href="#">Captiva</a></li>
                                                        <li><a href="#">Lacetti</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-md-2 col-sm-4 col-xs-6">
                                                <div class="brend-item">
                                                    <figure><img src="images/brend5.png" alt=""></figure>
                                                    <h6>Fiat</h6>
                                                    <ul>
                                                        <li><a href="#">500</a></li>
