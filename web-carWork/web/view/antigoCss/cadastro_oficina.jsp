...
="dropdown-toggle" data-toggle='dropdown' href="#">Home <span class
...
="dropdown-toggle" data-toggle='dropdown' href="#">Serviços<span class
...
="dropdown-toggle" data-toggle='dropdown' href="#">Quem Somos <span class
...
<input type="text" class="form-control" name="nome" id="nome"  placeholder="Informe o Nome da Sua Oficia"/>
</div>
</div>
</div>
...
<input type="text" class="form-control" name="endereço" id="endereço"  placeholder="Informe o Endereço da Oficina"/>
</div>
</div>
</div>
...
<div class="input-group">
<span class="input-group-addon"><i class="fa fa-users fa" aria-hidden="true"></i></span>
<input type="text" class="form-control" name="telefone" id="telefone"  placeholder="Informe o Telefone da Oficina"/>
</div>
</div>
</div>
...
<div class="input-group">
<span class="input-group-addon"><i class="fa fa-users fa" aria-hidden="true"></i></span>
<input type="text" class="form-control" name="cnpj" id="cnpj"  placeholder="Informe o CNPJ da Oficina"/>
</div>
</div>
</div>
...
<div class="input-group">
<span class="input-group-addon"><i class="fa fa-users fa" aria-hidden="true"></i></span>
<input type="text" class="form-control" name="login" id="login"  placeholder="Informe o Login"/>
</div>
</div>
</div>
...
<div class="input-group">
<span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
<input type="password" class="form-control" name="confirmação" id="confirmação"  placeholder="Confirme Sua Senha"/>
</div>
</div>
</div>
